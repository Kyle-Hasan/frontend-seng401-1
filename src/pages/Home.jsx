                ...
                <div className="col-md-12">
                    <div className="row align-items-center text-white ">
                        ...
                        <div className="col-md-4 offset-right-8 col-sm-3 mt-5 pt-4" data-aos="fade-right">
                            ...
                            <img className="pull-right"  src="https://cdn.discordapp.com/attachments/930491173141897360/958557312656760884/Untitled_design-removebg-preview.png" alt="" width=""/>
                            </div>
                            </div>
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="row align-items-center">
                       ...
                       <img src = "https://cdn.discordapp.com/attachments/930491173141897360/958557312656760884/Untitled_design-removebg-preview.png"></img>
                        </div>
                    </div>
